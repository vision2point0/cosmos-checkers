...
// Add methods to get the start and end time if needed
func (storedGame StoredGame) GetStart() int64 {
	return storedGame.StartTime
}

func (storedGame StoredGame) GetEnd() int64 {
	return storedGame.EndTime
}
